function [wall,allbounds,MTpos,plusdir,mindir,nMTdomain,MTdomain,MTstartbound,MTendbound] = getConfigWallsModified_full(x_coords,marker_positions,snaptol,domainends)
